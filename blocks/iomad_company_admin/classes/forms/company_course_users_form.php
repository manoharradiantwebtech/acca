...
class company_course_users_form extends moodleform {
    ...
    public function definition_after_data() {
        ...
        /**
         * Start Changes
         * IOMAD - Done the ui changes-.
         * @package iomad_company_admin
         * @author Radiant Web Tech
         */
        $mform->addElement('html', '
              </td>
              <td id="buttonscell">
                      <input name="add" id="add" class="btn
                        btn-primary add_course_users_form" type="submit" value="&nbsp;' .
            $output->larrow().'&nbsp;'. get_string('enrol', 'block_iomad_company_admin') .
            '" title="Enrol" /></br>
                      <input name="addall" id="addall" class="btn
                        btn-primary add_course_users_form" type="submit" value="&nbsp;' .
            $output->larrow().'&nbsp;'. get_string('enrolall', 'block_iomad_company_admin') .
            '" title="Enrolall" /></br>

                      <input name="remove" id="remove" class="btn
                        btn-primary add_course_users_form" type="submit" value="' .
            $output->rarrow().'&nbsp;'. get_string('unenrol', 'block_iomad_company_admin') .
            '&nbsp;" title="Unenrol" /></br>
                      <input name="removeall" id="removeall" class="btn
                        btn-primary add_course_users_form" type="submit" value="&nbsp;' .
