...
class company_edit_form extends \company_moodleform {
    ...
    public function definition() {
        ...
        if (iomad::has_capability('block/iomad_company_admin:company_edit_appearance', $context) ||
            ...
            /**
             * Start Changes
             * IOMAD - Set the condition to true for our Radiant theme by checking if the variable $companytheme is equal to 'radiant'.
             * @package iomad_company_admin
             * @author Radiant Web Tech
             */
            if ( preg_match('/iomad/', $this->companyrecord->theme) || $ischild || $companytheme == 'radiant') {
