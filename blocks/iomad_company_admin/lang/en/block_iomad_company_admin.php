...
$string['companydomains_help'] = 'This is the list of company email domains which will be used to auto assign users to this company through the local signup plugin.';
...
$string['companylogo_desc'] = 'A full logo to be used as decoration for the <i>currently selected</i> company by some themes (such as core and themes). This image can be quite high resolution because it will be scaled down for use (and cached for performance). Logos that are wider than they are high usually give better results.';
 ...
 */
$string['dashboard'] = 'Multi-Tenant Dashboard';
...
$string['edit_companies_title'] = ' company settings';
...
$string['firstcompany'] = 'You must create at least one company before you can use ';
...
$string['iomad_company_admin:addinstance'] = 'Add a new company admin block';
...
$string['iomad_company_admin:manageallcourses'] = 'Manage course settings for all companies and courses';
...
$string['iomad_company_admin:myaddinstance'] = 'Add a new company admin block to the users dashboard';
$string['iomad_company_admin:restrict_capabilities'] = 'Restrict role capabilties for company';
...
$string['pluginname'] = ' Company / User Admin';
...
$string['privacy:metadata'] = 'The Company admin block only shows data stored in other locations.';
