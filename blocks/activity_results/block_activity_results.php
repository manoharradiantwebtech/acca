...
class block_activity_results extends block_base {
    ...
    public function get_content() {
     ...
     /**
       * Start Changes.
       * Multi-tenant - Get the user's company details..
     ...
     /**
       * Start Changes.
       * Multi-tenant - added the And condition to check is user belong to company or not..
       * @author Radiant Web Tech
       */
                $params[] = $company->id;
            ...
            case SEPARATEGROUPS:
                ...
                list($grouptest, $params) = $DB->get_in_or_equal(array_keys($mygroups));
               	/**
                  * Start Changes.
                  * Multi-tenant - Checking is user belong to company or not.
                  * @author Radiant Web Tech
                  */
	        $params[] = $company->id;
