...
if (!$csv) {
    ...
    /**
     * Start Changes
     * Added new header for course completion.
     * @author Radiant Web Tech
     */
    //added new column in csv file to show the course completion percentage
    $row[] = get_string('completionpercentage', 'report_completion');
    //End changes
