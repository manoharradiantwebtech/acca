    ...
    public function col_coursename($row) {
        ...
        if (!$this->is_downloading()) {
            ...
            if (iomad::has_capability('local/report_users:view', $systemcontext)) {
                /**
                 * Start Changes.
                 * Make the report completion button
                 * @author Radiant Web Tech
                 */
                $params['course'] = $row->id;
                $cell .=  $output->single_button(new moodle_url('/report/progress/index.php',
                    $params), 'Activity completion');
                $cell .= "</br>";
                //End Changes
            ...
            if (iomad::has_capability('local/report_user_license_allocations:view', $systemcontext) && $haslicenses) {
                ...
                /**
                 * Start Changes.
                 * Hide the local_report_user_license_allocations
                 * @author Radiant Web Tech
                 */
                /*
                ...
                */
                $params['id'] = $row->id;
                $cell .=  $output->single_button(new moodle_url('/report/log/index.php',
                    $params), 'Logs');
                //End
            }
            return $cell;
