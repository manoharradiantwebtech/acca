...
class local_feedback_renderable implements renderable {
    public $page;
    ...
    public function setup_table() {
        ...
        $this->tablequery = new local_feedback_table_query('local_feedback', $filter);
    ...
    public function download() {
        $filename = 'feedback' .  userdate(time(), get_string('backupnameformat', 'langconfig'), 99, false);
