...
export default class Drawers {
    ...
    static eventTypes = {
         ...
         */
        drawerShow: 'theme_radiant/drawers:show',
         ...
         */
        drawerShown: 'theme_radiant/drawers:shown',
         ...
         */
        drawerHide: 'theme_radiant/drawers:hide',
         ...
         */
        drawerHidden: 'theme_radiant/drawers:hidden',
    };
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_radiant/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_radiant/drawers:close');
