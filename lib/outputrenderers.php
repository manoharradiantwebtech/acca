...
//End
    ...
    public function full_header() {
        ...
        /**
         * Start Changes
         * To check the page url and if set than show the student course side navigation.
         * @package core
         * @author Radiant Web Tech
         */
        if ((strpos($_SERVER['REQUEST_URI'], '/mod') !== false || strpos($_SERVER['REQUEST_URI'], '/course/view') !== false)  && !is_siteadmin()) {
            ...
            $sql = 'SELECT ue.timecreated
                    ...
                    ';
            $enrollment_date =  $DB->get_record_sql($sql, array('userid' => $USER->id, 'courseid' => $COURSE->id));
            $header->enrollment_date = date("d-M-Y", $enrollment_date->timecreated);
            $header->studentmodpage = true;
