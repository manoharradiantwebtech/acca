...
class core_course_renderer extends plugin_renderer_base {
    ...
    protected function coursecat_subcategories(coursecat_helper $chelper, $coursecat, $depth) {
        ...
        if (!$chelper->get_categories_display_option('nodisplay')) {
            ...
            /**
             * Start Changes
             * Multi-tenant - Filter out unwanted categories..
    ...
    protected function coursecat_category(coursecat_helper $chelper, $coursecat, $depth) {
        ...
        /**
         * Start Changes
         * Multi-tenant - changing the way categories get loaded as otherwise it results in a _lot_ of DB calls on the front page...
         * @author Radiant Web Tech
         */
	...
	/**
          * Start Changes
          * Multi-tenant - deal with licensed courses..
          * @author Radiant Web Tech
          */
