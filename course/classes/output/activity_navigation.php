...
class activity_navigation implements renderable, templatable {
    ...
    public function __construct($prevmod, $nextmod, $activitylist = array()) {
        ...
        if ($prevmod) {
            ...
            /**
             * Start Changes
             * Added class to show the arrow before link.
	     * Radiant web tech.
             */
            $html = \html_writer::div('<i class="fa fa-long-arrow-left transition mr-2"></i>');
            //END
            $this->prevlink = new \action_link($linkurl, $html . ' ' . $linkname, null, $attributes);
        }
        ...
        if ($nextmod) {
            ...
            /**
             * Start Changes
             * Added class to show the arrow after link.
	     * Radiant web tech.
             */
            $html = \html_writer::div('<i class="fa fa-long-arrow-right transition ml-2"></i>');
            //END
            $this->nextlink = new \action_link($linkurl, $linkname . ' ' . $html, null, $attributes);
        }
