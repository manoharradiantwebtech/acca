...
class core_course_category implements renderable, cacheable_object, IteratorAggregate {
	...
	/**
          * Start Changes
          * Multi-tenant - dont show categories which a user can't see..
	...
	/**
          * Start Changes
          * Multi-tenant - Remove courses which don't belong to your company and add in shared courses..
          * @author Radiant Web Tech
          */
	...
	/**
          * Start Changes
          * Multi-tenant - Do the empty check again...
          * @author Radiant Web Tech
          */
        if (empty($sortedids)) {
            return array();
	...
	/**
          * Start Changes
          * Multi-tenant - only use cache if allowed...
          * @author Radiant Web Tech
          */
	...
	/**
          * Start Changes
          * Multi-tenant - strip out courses user shouldn't see...
          * @author Radiant Web Tech
          */
            if (!PHPUNIT_TEST) {
	...
	/**
          * Start Changes
          * Multi-tenant - Filter the list of categories...
          * @author Radiant Web Tech
          */
	...
	/**
          * Start Changes
          * Multi-tenant - check the user capabilities..
          * @author Radiant Web Tech
          */
