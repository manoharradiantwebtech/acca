    ...
    public function col_status($data) {
        ...
        if ($canreviewenrol) {
            ...
            foreach ($userenrolments as $ue) {
                ...
                /**
                 * Start Changes
                 * Add the condition to identify which users have enrolled through the web and which ones have enrolled manually
                 * @package User Enrolment
                 * @author Radiant Web Tech
                 */
                if ($DB->get_record('user_purchase_history', array('userid' => $ue->userid, 'courseid' => $COURSE->id))) {
                    $instancename = 'web';
                } else {
