...
class profile_field_base {
	...
	/**
          * Start Changes
          * Multi-tenant - is this a company manager and can they edit this user...
...
function profile_get_user_fields_with_data(int $userid): array {
    ...
    /**
      * Start Changes
      * Multi-tenant - Filter the categories..
      * @author Radiant Web Tech
      */
...
function profile_definition(MoodleQuickForm $mform, int $userid = 0): void {
    ...
    /**
      * Start Changes
      * Multi-tenant - Filter categories which only apply to this company..
      * @author Radiant Web Tech
      */
