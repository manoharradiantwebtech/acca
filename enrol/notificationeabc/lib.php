<?php
// This file is part of Moodle - https://protect-eu.mimecast.com/s/9iAMCxBDUBxowJFYFGQC?domain=moodle.org
//
...
// along with Moodle.  If not, see <https://protect-eu.mimecast.com/s/zOVVCyDEfJL5kNuRmAvV?domain=gnu.org>.
 ...
 * @license    https://protect-eu.mimecast.com/s/RlTDCzEGhn4o9RioqqIb?domain=gnu.org GNU GPL v3 or later
...
class enrol_notificationeabc_plugin extends enrol_plugin
{
    ...
    public function enviarmail(stdClass $user, stdClass $course, $type) {
        ...
        $eventdata->subject = get_string('subject', 'enrol_notificationeabc',$course);
        // Replace <br> tags with newline characters
        $mensaje = str_replace(['<br>', '<br />', '<br/>'], "\n", $mensaje);
       // Convert HTML to plain text
        $plainTextMessage = strip_tags($mensaje);
        $eventdata->fullmessage = $plainTextMessage; // Set the plain text content
